...
#Rename state variables to have a different name with respect to county-level ones
data_wages_state %<>% 
...
saveRDS(panel1, file="data/f_panel_pa.rds") #pa stands for partially trimmed
saveRDS(panel2, file="data/f_panel_pa_wo_small.rds")
saveRDS(panel3, file="data/f_panel_tr.rds")
saveRDS(panel4, file="data/f_panel_tr_wo_small.rds")