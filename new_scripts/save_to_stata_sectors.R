...
data <- readRDS(file="data/f_panel_sectors_tr.rds")
...
write.csv(data, "data/panel_sectors_csv.csv", row.names = FALSE)
haven::write_dta(data, "stata_rob/panel_sectors_dta.dta")
